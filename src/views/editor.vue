<template >
  <v-container>
    <div class="save-indicator"
         :active="isSaving">
      <v-progress-circular color="green"
                           indeterminate
                           :value="0"
                           size="14"
                           class="ml-2 mb-2"
    ...
    <v-layout pa-1
      ...
      <v-flex xs12
        ...
        <v-btn-toggle v-model="boardIcon"
                      class="transparent mt-1 mb-5">
          <template v-for="(icon,i) in boardIcons">
            <v-btn :value="icon.value"
                   :color="icon.color"
                   :key="i"
                   flat>
      ...
      <v-flex xs12
        ...
        <v-card class="pa-3 elevation-3">
          ...
          <v-overflow-btn :items="dropdownCategory"
                          v-model="category"
                          @change="onChangeCateogory"></v-overflow-btn>
          <v-switch class="mt-2"
                    color="success"
                    :rules="[()=>{return title === ''}, ]"
                    v-model="isPublish"
    ...
    <v-btn @click="uploadHtml">Html Upload</v-btn>
    <v-btn @click="uploadMD">MD Upload</v-btn>
